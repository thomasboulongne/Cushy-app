<template>
	<div id="my-movies" :class="genres[0]">
		...
		<div class="overlay" v-show="overlay" ref="overlay">
			<svg class="logo" ref="logo" version="1.1" id="logo_1_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 90 90" style="enable-background:new 0 0 90 90;" xml:space="preserve">
				<path style="fill-rule:evenodd;clip-rule:evenodd;fill:#FFFFFF;" id="logo" class="st0" d="M88.4,69.2c0.8-4.2,1.2-13.9-3-34.1c-3.6-17.5-7.2-25.7-9.5-29.5c0-1.8,0.4-4.8-1.9-5.5
